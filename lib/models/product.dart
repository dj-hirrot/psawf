import 'package:psawf/models/item.dart';
import 'package:psawf/models/material.dart';
...
class Product {
  ...
  factory Product.fromJson(Map<String, dynamic> json) {
    return Product(
      ...
      material: PsawfMetarial.fromJson(json['material']),
    );
  }
}